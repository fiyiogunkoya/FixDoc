...
from ..change_impact_format import (
    SEVERITY_EMOJI as _SEVERITY_EMOJI,
...
def _format_markdown(result: ImpactResult) -> str:
    ...
    Thin shim preserved for backward compatibility; real implementation lives
    in `fixdoc.change_impact_format` so the SaaS backend can reuse it.
    """
    return format_impact_markdown(result)
